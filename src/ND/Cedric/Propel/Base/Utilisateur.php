...
abstract class Utilisateur implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ND\\Cedric\\Propel\\Map\\UtilisateurTableMap';
    ...
    /**
     * @var        ObjectCollection|ChildUtilisateurDepartements[] Collection to store aggregation of ChildUtilisateurDepartements objects.
     */
     ...
     * @var ObjectCollection|ChildUtilisateurDepartements[]
     */
     ...
     *
     * @return $this|Utilisateur The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UtilisateurTableMap::COL_ID] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[UtilisateurTableMap::COL_EMAIL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UtilisateurTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UtilisateurTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UtilisateurTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = UtilisateurTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\ND\\Cedric\\Propel\\Utilisateur'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->utilisateurDepartementsQueriesScheduledForDeletion !== null) {
                if (!$this->utilisateurDepartementsQueriesScheduledForDeletion->isEmpty()) {
                    \ND\Cedric\Propel\UtilisateurDepartementsQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[UtilisateurTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . UtilisateurTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(UtilisateurTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(UtilisateurTableMap::COL_EMAIL)) {
            ...
            if (null !== $this->collUtilisateurDepartementsQueries) {
                ...
                switch ($keyType) {
                    case TableMap::TYPE_CAMELNAME:
                        $key = 'utilisateurDepartementss';
                        break;
                    case TableMap::TYPE_FIELDNAME:
                        $key = 'utilisateur_departementss';
                        break;
                    default:
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ND\Cedric\Propel\Utilisateur
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ND\Cedric\Propel\Utilisateur The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UtilisateurTableMap::COL_ID)) {
            $criteria->add(UtilisateurTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(UtilisateurTableMap::COL_EMAIL)) {
            $criteria->add(UtilisateurTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(UtilisateurTableMap::COL_PASSWORD)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ND\Cedric\Propel\Utilisateur (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ND\Cedric\Propel\Utilisateur Clone of current object.
     * @throws PropelException
     */
    ...
    public function initUtilisateurDepartementsQueries($overrideExisting = true)
    {
        ...
        $collectionClassName = UtilisateurDepartementsTableMap::getTableMap()->getCollectionClassName();

        $this->collUtilisateurDepartementsQueries = new $collectionClassName;
        $this->collUtilisateurDepartementsQueries->setModel('\ND\Cedric\Propel\UtilisateurDepartements');
    }

    /**
     * Gets an array of ChildUtilisateurDepartements objects which contain a foreign key that references this object.
     *
     ...
     * @return ObjectCollection|ChildUtilisateurDepartements[] List of ChildUtilisateurDepartements objects
     * @throws PropelException
     */
    public function getUtilisateurDepartementsQueries(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collUtilisateurDepartementsQueries || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collUtilisateurDepartementsQueries) {
                ...
                $collUtilisateurDepartementsQueries = ChildUtilisateurDepartementsQuery::create(null, $criteria)
    ...
    /**
     * Sets a collection of ChildUtilisateurDepartements objects related by a one-to-many relationship
    ...
    {
        /** @var ChildUtilisateurDepartements[] $utilisateurDepartementsQueriesToDelete */
    ...
    /**
     * Returns the number of related UtilisateurDepartements objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related UtilisateurDepartements objects.
     * @throws PropelException
     */
    public function countUtilisateurDepartementsQueries(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collUtilisateurDepartementsQueries || null !== $criteria || $partial) {
            ...
            $query = ChildUtilisateurDepartementsQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildUtilisateurDepartements object to this object
     * through the ChildUtilisateurDepartements foreign key attribute.
     *
     * @param  ChildUtilisateurDepartements $l ChildUtilisateurDepartements
     * @return $this|\ND\Cedric\Propel\Utilisateur The current object (for fluent API support)
     */
    public function addUtilisateurDepartementsQuery(ChildUtilisateurDepartements $l)
    {
        if ($this->collUtilisateurDepartementsQueries === null) {
            $this->initUtilisateurDepartementsQueries();
            $this->collUtilisateurDepartementsQueriesPartial = true;
    ...
    /**
     * @param ChildUtilisateurDepartements $utilisateurDepartementsQuery The ChildUtilisateurDepartements object to add.
     */
    protected function doAddUtilisateurDepartementsQuery(ChildUtilisateurDepartements $utilisateurDepartementsQuery)
    {
    ...
    /**
     * @param  ChildUtilisateurDepartements $utilisateurDepartementsQuery The ChildUtilisateurDepartements object to remove.
     * @return $this|ChildUtilisateur The current object (for fluent API support)
     */
    public function removeUtilisateurDepartementsQuery(ChildUtilisateurDepartements $utilisateurDepartementsQuery)
    {
    ...
    /**
     * Gets an array of ChildUtilisateurCommunes objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
    ...
    /**
     * Sets a collection of ChildUtilisateurCommunes objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    /**
     * Returns the number of related UtilisateurCommunes objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
    ...
    /**
     * Method called to associate a ChildUtilisateurCommunes object to this object
     * through the ChildUtilisateurCommunes foreign key attribute.
     *
