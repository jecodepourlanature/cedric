...
class UtilisateurTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ND.Cedric.Propel.Map.UtilisateurTableMap';
     ...
     */
    const OM_CLASS = '\\ND\\Cedric\\Propel\\Utilisateur';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ND.Cedric.Propel.Utilisateur';
     ...
     */
    const COL_ID = 'utilisateur.id';

    /**
     * the column name for the email field
     */
    const COL_EMAIL = 'utilisateur.email';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'password', ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_ID, UtilisateurTableMap::COL_EMAIL, UtilisateurTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'Password' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'password' => 2, ),
        self::TYPE_COLNAME       => array(UtilisateurTableMap::COL_ID => 0, UtilisateurTableMap::COL_EMAIL => 1, UtilisateurTableMap::COL_PASSWORD => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'password' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ND\\Cedric\\Propel\\Utilisateur');
    ...
    {
        $this->addRelation('UtilisateurDepartementsQuery', '\\ND\\Cedric\\Propel\\UtilisateurDepartements', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':utilisateur_id',
    1 => ':id',
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UtilisateurTableMap::COL_ID);
            $criteria->addSelectColumn(UtilisateurTableMap::COL_EMAIL);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ND\Cedric\Propel\Utilisateur) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(UtilisateurTableMap::DATABASE_NAME);
            $criteria->add(UtilisateurTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(UtilisateurTableMap::COL_ID) && $criteria->keyContainsValue(UtilisateurTableMap::COL_ID) ) {
